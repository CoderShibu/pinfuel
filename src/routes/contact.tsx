  ...
  head: () => ({
    meta: [
      { title: "Start a Project — PINFUEL" },
      {
        name: "description",
        content:
          "Initialize your project with PINFUEL. A cinematic onboarding workflow to engineer your digital presence.",
      },
    ],
  }),
    ...
    >
      ...
      <div className="relative w-32 h-32 mb-10">
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, transparent 270deg, oklch(from var(--color-accent) l c h / 0.15) 360deg)",
          }}
          animate={{ rotate: 360 }}
      ...
      <h2 className="text-xl font-mono mb-6 text-accent">Transmitting Project Intelligence...</h2>
  ...
  return (
    <motion.div
      ...
      style={{
        borderColor: "oklch(from var(--color-accent) l c h / 0.15)",
        background:
          "radial-gradient(ellipse at top, oklch(from var(--color-accent) l c h / 0.15), transparent 70%)",
      }}
    >
      {/* Icon */}
      <div className="relative inline-flex mb-8">
        <div className="w-20 h-20 rounded-full flex items-center justify-center bg-accent shadow-[0_0_50px_oklch(from_var(--color-accent)_l_c_h_/_0.15)]">
          <svg
            width="36"
            height="36"
            viewBox="0 0 24 24"
  ...
  return (
    <div className="min-h-screen relative flex flex-col lg:flex-row pt-24 pb-16 px-4 md:px-12 overflow-hidden bg-background text-foreground">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at bottom, var(--color-accent), transparent 55%)",
        }}
      />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center z-10 mb-16 lg:mb-0 lg:pr-12">
        <div className="max-w-md mx-auto lg:mx-0">
          ...
          >
            Bypass the gatekeepers. Directly interface with the core architects of the PINFUEL
            system to engineer your digital dominance.
          </motion.p>
          ...
          >
            <h3 className="text-xs font-mono uppercase tracking-widest text-subtle mb-6 border-b border-border pb-2">
              The Architects
            </h3>
            <div className="space-y-4">
              <div className="flex gap-5 items-center p-5 rounded-2xl border border-border bg-surface-2/50 backdrop-blur-sm hover:border-accent/30 transition-colors">
                <div className="w-14 h-14 shrink-0 rounded-full bg-accent/10 border border-accent/20 flex items-center justify-center text-accent font-mono font-bold text-lg">
                  SB
                </div>
                <div>
                  ...
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="text-[11px] font-mono text-accent hover:underline uppercase tracking-widest"
                    >
                      LinkedIn
                    </a>
                    <a
                      href="mailto:founder1@pinfuel.com"
                      className="text-[11px] font-mono text-accent hover:underline uppercase tracking-widest"
                    >
                      Email
                    </a>
              ...
              <div className="flex gap-5 items-center p-5 rounded-2xl border border-border bg-surface-2/50 backdrop-blur-sm hover:border-accent/30 transition-colors">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      href="mailto:founder2@pinfuel.com"
                      className="text-[11px] font-mono text-accent hover:underline uppercase tracking-widest"
                    >
                      Email
                    </a>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center z-10 relative">
        <div className="w-full max-w-lg relative glass-panel p-8 md:p-12 rounded-3xl">
          {/* Step indicator */}
          {!isProcessing && !isComplete && <StepIndicator step={step} total={TOTAL_STEPS} />}
          ...
          <AnimatePresence mode="wait">
              ...
              >
                      ...
                      style={{
                        ...
                        background:
                          selectedIndustry === ind
                            ...
                            : "transparent",
                        color:
                          selectedIndustry === ind ? "var(--color-accent)" : "var(--color-accent)",
                        boxShadow:
                          selectedIndustry === ind
                            ? "0 0 16px oklch(from var(--color-accent) l c h / 0.15)"
                            : "none",
                      }}
                    >
                      {ind}
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={back}
                    className="px-5 py-3 rounded-md font-mono text-xs uppercase tracking-widest border text-muted-foreground hover:text-foreground transition-colors border-accent/15"
                  >
                    ← Back
                  </button>
                  <button
                    type="button"
                    onClick={() => selectedIndustry && next()}
                    className="px-8 py-3 rounded-md font-mono text-xs uppercase tracking-widest font-bold text-accent-foreground transition-all disabled:opacity-40"
                    style={{
            ...
            {step === 3 && !isProcessing && !isComplete && (
              ...
              >
                ...
                <form onSubmit={next} className="space-y-7">
                  <InputField
                    label="Primary Social Link (Instagram, X, etc.)"
                    required
                    type="url"
                    placeholder="https://"
                  />
                  <div>
                    ...
                    >
                      ...
                      <option value="0-10k" style={{ background: "var(--color-background)" }}>
                        0 – 10,000
                      </option>
                      <option value="10k-100k" style={{ background: "var(--color-background)" }}>
                        10,000 – 100,000
                      </option>
                      <option value="100k-500k" style={{ background: "var(--color-background)" }}>
                        100,000 – 500,000
                      </option>
                      <option value="500k+" style={{ background: "var(--color-background)" }}>
                        500,000+
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      type="submit"
                      className="px-8 py-3 rounded-md font-mono text-xs uppercase tracking-widest font-bold text-accent-foreground bg-accent shadow-[0_0_20px_var(--color-accent)]"
                    >
                      Proceed →
                    </button>
                  </div>
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => next()}
                    className="px-8 py-3 rounded-md font-mono text-xs uppercase tracking-widest font-bold text-accent-foreground bg-accent"
                  >
                    Proceed →
                  </button>
                </div>
            ...
            {step === 6 && !isProcessing && !isComplete && (
              ...
              >
                ...
                <p className="font-mono text-subtle text-sm mb-8">
                  Verify system input before initializing transmission.
                </p>
                ...
                >
                  {[
                    ...
                    {
                      key: "Goals",
                      val: selectedGoals.length
                        ? `${selectedGoals.length} objective(s) selected`
                        : "—",
                    },
                    ...
                    <div
                      key={key}
                      className="flex justify-between border-b pb-3 last:border-0 last:pb-0 border-accent/15"
                    >
                ...
                <form onSubmit={submit} className="flex gap-3">
                  <button
                    type="button"
                    onClick={back}
                    className="px-5 py-3 rounded-md font-mono text-xs uppercase tracking-widest border text-subtle hover:text-white transition-colors border-accent/15"
                  >
                    ← Back
                  </button>
                  <button
