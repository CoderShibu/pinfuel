          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/10 bg-black/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm font-bold uppercase tracking-widest text-white">Project Intelligence Intake</h2>
                  <p className="text-[10px] font-mono text-accent uppercase tracking-widest">Secure Onboarding Protocol</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center gap-4 mb-8">
                        ...
                        <span className="font-mono text-xs text-accent uppercase tracking-widest">01. Identity Matrix</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <InputGroup label="Company / Brand Name" name="company" value={formData.company} onChange={handleChange} required />
                        <InputGroup label="Email Address" type="email" name="email" value={formData.email} onChange={handleChange} required />
                        <InputGroup label="Contact Number" type="tel" name="phone" value={formData.phone} onChange={handleChange} required />
                        <InputGroup label="Website URL" type="url" name="website" value={formData.website} onChange={handleChange} />
                        <InputGroup label="Instagram Handle" name="instagram" value={formData.instagram} onChange={handleChange} />
                        <InputGroup label="Industry Type" name="industry" value={formData.industry} onChange={handleChange} required />
                        <div className="space-y-2">
                          <label className="text-[11px] font-mono uppercase tracking-widest text-white/60">Target System</label>
                          <div className="relative group/input">
                            ...
                            <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none z-20 text-white/40">▼</div>
                    ...
                    <div className="space-y-6 pt-4">
                      <div className="flex items-center gap-4 mb-8">
                        <div className="h-px flex-1 bg-gradient-to-r from-accent/50 to-transparent" />
                        <span className="font-mono text-xs text-accent uppercase tracking-widest">02. Project Telemetry</span>
                        <div className="h-px flex-1 bg-gradient-to-l from-accent/50 to-transparent" />
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <InputGroup label="Monthly Marketing Budget" name="budget" value={formData.budget} onChange={handleChange} placeholder="$5k - $10k" required />
                        <InputGroup label="Expected Timeline" name="timeline" value={formData.timeline} onChange={handleChange} placeholder="Q3 2026" required />
                        <InputGroup label="Current Audience Size" name="audienceSize" value={formData.audienceSize} onChange={handleChange} placeholder="e.g. 50k IG, 10k Email" />
                        <InputGroup label="Preferred Platforms" name="platforms" value={formData.platforms} onChange={handleChange} placeholder="IG, X, LinkedIn" />
                      </div>

                      <div className="space-y-6">
                        <TextAreaGroup label="What does your brand currently struggle with?" name="struggles" value={formData.struggles} onChange={handleChange} required />
                        <TextAreaGroup label="What are your primary growth goals?" name="goals" value={formData.goals} onChange={handleChange} required />
                      </div>
                    </div>
                    ...
                    <div className="space-y-6 pt-4">
                      <div className="flex items-center gap-4 mb-8">
                        <div className="h-px flex-1 bg-gradient-to-r from-accent/50 to-transparent" />
                        <span className="font-mono text-xs text-accent uppercase tracking-widest">03. Asset Injection</span>
                        <div className="h-px flex-1 bg-gradient-to-l from-accent/50 to-transparent" />
                      </div>
                      <p className="text-xs text-white/50 font-mono text-center max-w-lg mx-auto mb-6 leading-relaxed">
                        To maintain secure protocols, please provide a link (Google Drive, Dropbox, Notion) containing any brand guidelines, social media screenshots, or analytics reports.
                      </p>
                      <InputGroup label="Asset Folder URL (Optional)" type="url" name="assetsUrl" value={formData.assetsUrl} onChange={handleChange} placeholder="https://drive.google.com/..." />
                    </div>
                    ...
                    <div className="pt-10 flex justify-center">
                      ...
                      >
                        <span className="relative z-10 font-mono uppercase tracking-widest flex items-center gap-3">
                          Enter The PP Influence System <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </span>
                ...
                {step === "processing" && (
                  ...
                  >
                    <div className="relative w-48 h-48 mb-12 flex items-center justify-center">
                      <div className="absolute inset-0 rounded-full border-t border-accent animate-spin" style={{ animationDuration: "1s" }} />
                      <div className="absolute inset-4 rounded-full border-b border-accent/50 animate-spin" style={{ animationDuration: "1.5s", animationDirection: "reverse" }} />
                      <div className="absolute inset-8 rounded-full border-l border-accent/30 animate-spin" style={{ animationDuration: "2s" }} />
                ...
                {step === "success" && (
                  ...
                  >
                    ...
                    >
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                      {/* Pulse rings */}
                      <motion.div
                    ...
                    <p className="text-white/60 font-mono text-sm max-w-md mx-auto mb-12 leading-relaxed">
                      Your request has successfully entered the PP Influence infrastructure. Our intelligence architects will initiate contact shortly.
                    </p>
...
function InputGroup({ label, name, value, onChange, type = "text", required = false, placeholder = "" }: any) {
  return (
    <div className="space-y-2">
